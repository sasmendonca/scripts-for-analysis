...
Batch compute descriptors (logP, LogS, molecular weight, H-bond donors/acceptors, etc.) from SMILES/SDF/CSV inputs.
...
Visualize dataset overlaps with PCA, t-SNE, or scaffold-based clustering from the bitbirch package.
